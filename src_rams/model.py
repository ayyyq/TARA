...
class MyModel(nn.Module):
    def __init__(self,
        ...
        node_type_num = 3  # context/trigger/argument candidates
    ...
    def forward(
        ...
        for example_idx, cur_big_graph in enumerate(graphs):
            ...
            pruned_span_list = [trigger_spans[example_idx].tolist()] + pruned_span_list
        ...
        for cur_span_info, node_idx_list in zip(all_span_infos, all_node_idx_list):
            ...
            all_span_features.append(span_features[1:])
